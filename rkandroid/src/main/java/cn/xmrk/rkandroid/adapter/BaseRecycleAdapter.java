...
public abstract class BaseRecycleAdapter<T, D extends BaseRecycleViewHolder> extends RecyclerView.Adapter<D> {
    ...
    protected OnViewHolderClickListener<D> mOnViewHolderClickListener;

    public void setOnViewHolderClickListener(OnViewHolderClickListener<D> mOnViewHolderClickListener) {
